...
See [default theme CSS variables](https://github.com/nuecms/nueui/blob/main/src/client/theme-default/styles/vars.css) that can be overridden.
...
To know the exact name of the component refer [our source code](https://github.com/nuecms/nueui/tree/main/src/client/theme-default/components). Since the components are internal, there is a slight chance their name is updated between minor releases.
